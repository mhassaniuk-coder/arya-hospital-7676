...
const ThemeToggle: React.FC<ThemeToggleProps> = ({
    ...
    const themeOptions: { value: ThemeMode; icon: React.ReactNode; label: string }[] = [
        { value: 'light', icon: <SunIcon className={sizeConfig[size].icon} />, label: 'Light' },
        { value: 'dark', icon: <MoonIcon className={sizeConfig[size].icon} />, label: 'Dark' },
        { value: 'system', icon: <MonitorIcon className={sizeConfig[size].icon} />, label: 'System' },
    ];
    ...
    const getCurrentIcon = () => {
        if (theme === 'system') {
            return <MonitorIcon className={sizeConfig[size].icon} />;
        }
        return isDark ? <SunIcon className={sizeConfig[size].icon} /> : <MoonIcon className={sizeConfig[size].icon} />;
    };
